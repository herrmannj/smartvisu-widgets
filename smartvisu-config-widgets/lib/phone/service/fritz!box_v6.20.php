 ...
 * -----------------------------------------------------------------------------
 * @package     smartVISU
 * @author      Martin Gleiß, A.Schwithal
 * @copyright   2012 - 2015
...
/**
 * This class reads the phonelist of an fritz!box phonesystem 7490
 */
class phone_fritzbox_v6_20 extends phone
{
	private $login_parm;
	private $csv;
	...
	private function connect()
	{
		...
		$response = file_get_contents('http://'.$this->server.'/login_sid.lua?username='.$this->user, false, stream_context_create($context));
		$this->login_parm = '';
...
$service = new phone_fritzbox_v6_20(array_merge($_GET, $_POST));
echo $service->json();
